...
<%
    ...
    pageContext.setAttribute("paginaActual", "mis-prestamos");
%>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body class="bg-gray-50">
        ...
        <div class="container mx-auto px-2 sm:px-4 relative">
            ...
            <div class="sm:hidden flex items-center justify-between py-2">
                ...
                <span class="text-sm font-medium text-slate-700">
                    <i class="fas fa-book-reader mr-1"></i>Mis Préstamos
                </span>
                <div class="w-10"></div>
            </div>
    ...
    <div class="container mx-auto px-2 sm:px-4 py-4 sm:py-8">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div class="p-3 sm:p-6 border-b border-gray-200">
                <div class="mb-4">
                    <h2 class="text-xl sm:text-2xl font-bold text-gray-800">
                        <i class="fas fa-book-reader text-gray-600 mr-2"></i>
                        Mis Préstamos
                    </h2>
                    <p class="text-gray-600 text-xs sm:text-sm mt-1">Consulta el historial y estado de tus préstamos de libros</p>
                </div>
                <div class="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3">
                    ...
                    <div class="flex gap-2">
                        <select id="filtro-estado" class="px-3 py-2 border border-gray-300 rounded-md focus:ring-1 focus:ring-slate-500 focus:border-slate-500 text-sm bg-white">
                            ...
                            <option value="prestado">Préstamos activos</option>
            ...
            <div class="overflow-x-auto">
                ...
                <table class="min-w-full divide-y divide-gray-200 hidden sm:table">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Días</th>
                            <th class="px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Acciones</th>
                        </tr>
                    </thead>
                    <tbody id="tabla-prestamos" class="bg-white divide-y divide-gray-200">
                        <!-- Fila de carga -->
                        <tr id="carga-prestamos">
                ...
                <!-- Vista Mobile - Cards -->
                <div id="prestamos-mobile" class="block sm:hidden space-y-3">
                    <!-- Indicador de carga móvil -->
                    <div id="carga-prestamos-mobile" class="text-center py-8 text-gray-500">
                        <i class="fas fa-spinner fa-spin mr-2"></i>Cargando préstamos...
                    </div>
                </div>
            </div>
                ...
                <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                    <div>
                        <p class="text-sm text-gray-700">
                            Mostrando préstamos página <span class="font-medium" id="pagina-actual">1</span> de 
                            <span class="font-medium" id="total-paginas">1</span>
                        </p>
                    </div>
                    <div>
                        <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" id="paginacion-prestamos">
            ...
            <div class="px-3 sm:px-6 py-3 sm:py-4 border-t border-gray-200 bg-gray-50">
                <div class="text-xs sm:text-sm text-gray-700">
                    Total de préstamos: <span id="total-prestamos" class="font-semibold">0</span>
                </div>
            </div>
        </div>
    </div>

    <div id="modalDetallePrestamo" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 p-2 sm:p-0">
            ...
            <div class="mt-2 sm:mt-3">
                <div class="flex justify-between items-center pb-2 sm:pb-3 border-b border-gray-200">
                    <h3 class="text-lg sm:text-xl font-bold text-gray-900">
                        <i class="fas fa-info-circle text-slate-600 mr-2"></i>Detalles del Préstamo
                    </h3>
                ...
                <div class="mt-4">
                    ...
                    <div class="bg-slate-50 p-4 rounded-lg mb-4 border border-slate-200">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                            ...
                            <div id="detalle-fecha-devolucion-real-container" class="hidden sm:col-span-2">
                    ...
                    <div id="detalle-dias-container" class="bg-slate-50 p-4 rounded-lg mb-4 border border-slate-200">
                        ...
                        <div class="text-sm">
                            ...
                            <p id="detalle-dias-descripcion" class="text-gray-600 mt-1"></p>
                        </div>
                    </div>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/mis-prestamos.js"></script>
</body>
</html>